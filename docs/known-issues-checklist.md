...
> ✅ 注：原 **P3-6 热度分双路径口径不一致** 已于 2026-08-31 修复；原 **P3-7 本地消息表无有效重试/死信 + refreshTaskToRedis 无锁**、**P3-10 成就查询全量计算非事件驱动**、**P3-12 审核链顺序硬编码、重试用 Thread.sleep**、**P3-13 审计表只记失败不记通过** 已于 2026-09-01 修复，均从下表移除。
