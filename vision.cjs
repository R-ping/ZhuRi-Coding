...
const BASE_URL = process.env.DASH_SCOPE_OPENAI_HOST || "https://dashscope.aliyuncs.com/compatible-mode/v1";
const API_KEY = process.env.DASH_SCOPE_API_KEY || "";
const MODEL = process.env.VISION_MODEL || "qwen3.8-max";
function parseArgs() {
