package com.zhuri.coding.apis.reward;

import com.zhuri.coding.apis.reward.fallback.IRewardClientFallback;
...
@FeignClient(value = "zhuri-coding-reward", fallback = IRewardClientFallback.class)
