...
import com.zhuri.coding.apis.search.fallback.IUserSearchClientFallback;
 ...
 */
@FeignClient(value = "zhuri-coding-user", contextId = "zhuri-coding-user-searchClient", fallback = IUserSearchClientFallback.class)
